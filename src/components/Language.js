...
//         <div>
//               <Navbar></Navbar>
//             <MainHeding head='Language'></MainHeding>
//             <ProductsParent info="Language"></ProductsParent>
//         </div>
//     )
// }
                                ...
                                <div className="row row-col-1 row-col-sm-3 m-1">
                                    ...
                                    <div className="col-3  m-1 ">
                                        <div className="row row-col-1">
                                            ...
                                            <div className="col">
                                                <div>
                                                    <button className="btn btn-primary m-1 p-3" key={i+20} onClick={() => { 
                                                                return(
                                                                props.add(i+20)
                                                            );}}>+
                                                    </button>
                                                    <h3>{props.count(i+5)}</h3> 
